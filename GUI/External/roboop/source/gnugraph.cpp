...
#include <memory.h>
#include "gnugraph.h"
#include "C:\Jarboter_V_2_1\Comunicacion\Interface_PC_Controlador\Include\mem.h"
...
//!  @brief Creates a GNUplot graphic.
{
	...
	fileout << "plot \\\n";
	/*Para graficar mas de una variable*/
	...
	fileout << "\n";
	/*Crea el nombre del archivo de los puntos*/
                 ...
                 int start_y, int end_y)
{
	...
	Plot2d plotgraph;
	char *legend=0;
	int longitud=strlen(label);
	/*OJO DESCOMENTAR*/
    legend = (char*)declarar(sizeof(char)*strlen(label)+5);
	if(legend ==NULL)  
