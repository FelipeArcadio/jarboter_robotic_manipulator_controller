...
*/
{
	...
	//CAMBIO POR FELIPE HURTADO 2 ABRIL 2009 /*e*/
...
/*FUNCION AÑADIDA */
/*Tobj_DH: Es una matriz que contiene toda la informacion del robot y el punto objetivo
                fxc
	Tobj_DH=[  R3x3   P3x1 04x2 ]
			[   000    	1       ]
			[       D-H5x6	    ]9x6
  
*/
ReturnMatrix Robot::inv_kin_JARBOTER(const Matrix & Tobj_DH)
{
    ColumnVector P(3),Pm(3),a(3),o(3),n(3),qout(4),SumSq;
    
	Real d1,d5,R,r,temp,beta,alfa,a2,a3,s5,s1,c1,s234,c234,tetha234;
						  //f c
	a<<Tobj_DH.SubMatrix(1,3,3,3);
	o<<Tobj_DH.SubMatrix(1,3,2,2);
	n<<Tobj_DH.SubMatrix(1,3,1,1);
    P<<Tobj_DH.SubMatrix(1,3,4,4);
	/*D5*/
	d5=Tobj_DH(9,2);
	cout << "D5\n";
	cout << setw(10) << setprecision(5) << d5;
	cout << "\n";
	/*VECTOR A*/
	cout << "vector a\n";
	...
	Pm=P-a*d5;
	cout << "vector PM\n";
	cout << setw(10) << setprecision(5) << Pm;
	cout << "\n";
	/*D1*/
	d1=Tobj_DH(5,2);
	cout << "D1\n";
	cout << setw(10) << setprecision(5) << d1;
	cout << "\n";
	Pm(3)=Pm(3)-d1;
	/*PM RESTADO*/
	cout << "vector PM [Pm(3)-d1] \n";
	cout << setw(10) << setprecision(5) << Pm;
	cout << "\n";
	/*R*/
	SumSq =Pm.sum_square_columns();
	cout << "SumSq\n";
	cout << setw(10) << setprecision(5) << SumSq;
	R=SumSq.as_scalar();
	R=sqrt(R);
	cout << "Real R\n";
	cout << setw(10) << setprecision(5) << R;
	cout << "\n";
	/*r*/
	temp=Pm(3);
	Pm(3)=0;
	...
	a2=Tobj_DH(6,3);
	cout << "a2\n";
	cout << setw(10) << setprecision(5) << a2;
	cout << "\n";
	/*A3*/
	a3=Tobj_DH(7,3);
	cout << "a3\n";
	cout << setw(10) << setprecision(5) << a3;
	cout << "\n";
	/*COS Y SENO ALFA*/
	//alfa= abs(acos( ((R*R)+(a2*a2)-(a3*a3)) / (2*R*a2) ));
	temp=R / (2*a2);
	cout << "ARGUMENTO PARA ALFA\n";
	cout << setw(10) << setprecision(5) << temp;
	cout << "\n";
	alfa=abs(acos(  R / (2*a2)  ));
	alfa=alfa/(M_PI/180);
	cout << "alfa en grados\n";
	cout << setw(10) << setprecision(5) << alfa;
	cout << "\n";
	/*Q1*/
	qout(1) = atan2(P(2),P(1));
	s1=sin(qout(1));
	c1=cos(qout(1));
	qout(1) = qout(1)/(M_PI/180);
	cout << "q1 en grados\n";
	cout << setw(10) << setprecision(10) << qout(1);
	cout << "\n";
	/*Q2*/

	qout(2) = -abs(alfa+beta);
	cout << "q2 en grados\n";
	cout << setw(10) << setprecision(10) << qout(2);
	cout << "\n";
	/*Q3*/
	temp=((R*R)-(a2*a2)-(a3*a3)) / (2*a2*a3);
	cout << "ARGUMENTO PARA Q3\n";
	cout << setw(10) << setprecision(10) << temp;
	cout << "\n";
	if(temp>1)
		temp=1;
	qout(3) =acos( temp );
	...
	cout << "q3 en RADIANES\n";
	cout << setw(10) << setprecision(5) << qout(3);
	cout << "\n";
	qout(3) = qout(3)/(M_PI/180);
	cout << "q3 en grados\n";
	cout << setw(10) << setprecision(5) << qout(3);
	cout << "\n";
	/*q4*/	
	...
	s234=c1*a(1)+s1*a(2);
	c234=-a(3);
	tetha234=atan2(s234,c234);
	qout(4)=tetha234-qout(3)-qout(2);
	qout(4) = qout(4)/(M_PI/180);
	cout << "q4 en grados\n";
	cout << setw(10) << setprecision(5) << qout(4);
	cout << "\n";
	/*q5*/
	s5=s1*n(1)-c1*n(2);
/*	c5=s1*o(1)-c1*o(2);
	qout(5)=atan2(s5,c5);
	qout(5) = qout(5)/(M_PI/180);
	cout << "q5 en grados\n";
	cout << setw(10) << setprecision(5) << qout(5);
	cout << "\n";
*/
    qout.Release();
    return qout;
