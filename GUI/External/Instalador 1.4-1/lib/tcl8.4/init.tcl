...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Dec 05, 2005
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.12.0.226725 Win32/x86, Mon Dec 05 11:51:53 PM Pacific Standard Time 2005
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1133855513}
	buildtime,fmt {Mon Dec 05 11:51:53 PM Pacific Standard Time 2005}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.12.0.226725 Win32/x86 @ Mon Dec 05 11:51:53 PM Pacific Standard Time 2005 / normal}
    }
}

package provide {ActiveTcl} {8.4.12.0.226725}
