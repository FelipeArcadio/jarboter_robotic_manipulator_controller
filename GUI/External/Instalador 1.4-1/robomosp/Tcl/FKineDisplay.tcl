# --------------------------------------------------------------------------------------------------------------------------
#  FKineMatrixDisplay.tcl
#		This file implements the ROBOMOSP fkine matrix display window.
#
...
namespace eval FKineMatrixDisplay {
  ...
  variable tplFK .wndFKMatrixDisplay
  variable frmFKTB $tplFK.frmToolBar
  variable Cell_00 $tplFK.frmRow0.entCell_00
  variable Cell_01 $tplFK.frmRow0.entCell_01
  variable Cell_02 $tplFK.frmRow0.entCell_02
  variable Cell_03 $tplFK.frmRow0.entCell_03
  variable Cell_10 $tplFK.frmRow1.entCell_10
  variable Cell_11 $tplFK.frmRow1.entCell_11
  variable Cell_12 $tplFK.frmRow1.entCell_12
  variable Cell_13 $tplFK.frmRow1.entCell_13
  variable Cell_20 $tplFK.frmRow2.entCell_20
  variable Cell_21 $tplFK.frmRow2.entCell_21
  variable Cell_22 $tplFK.frmRow2.entCell_22
  variable Cell_23 $tplFK.frmRow2.entCell_23
  variable Cell_30 $tplFK.frmRow3.entCell_30
  variable Cell_31 $tplFK.frmRow3.entCell_31
  variable Cell_32 $tplFK.frmRow3.entCell_32
  variable Cell_33 $tplFK.frmRow3.entCell_33
  variable CellWidth 10
  variable FKineMatrixDisplayInit 0
  ...
  proc Delete {} {
	variable tplFK
	variable FKineMatrixDisplayInit
    set FKineMatrixDisplayInit 0
  ...
  proc Initialize {} {
    ...
    variable CellWidth
    variable FKineMatrixDisplayInit
	set FKineMatrixDisplayInit 1


    # Initialization of matrix display
    RobLab::CreateWindow "" wndFKMatrixDisplay "Position and Orientation" "$RobLab::FKineMD_Geometry" $RobLab::WndMinSizeX $RobLab::WndMinSizeY . 0 { FKineMatrixDisplay::Delete } $RobLab::VirtualGridSize
    ...
    pack $tplFK.frmRow0 -side top -fill both -expand true
    ...
    pack $tplFK.frmRow1 -side top -fill both -expand true
    ...
    pack $tplFK.frmRow2 -side top -fill both -expand true
    ...
    pack $tplFK.frmRow3 -side top -fill both -expand true
