# --------------------------------------------------------------------------------------------------------------------------
#  AccelDisplay.tcl
#		This file implements the ROBOMOSP acceleration matrix display window.
#
...
namespace eval AccelMatrixDisplay {
  ...
  # Initialization of global Accel
  variable tplAccel .wndAccelMatrixDisplay
  variable frmAccelTB $tplAccel.frmToolBar
  variable Cell_00 $tplAccel.frmRow0.entCell_00
  variable Cell_01 $tplAccel.frmRow0.entCell_01
  variable Cell_02 $tplAccel.frmRow0.entCell_02
  variable Cell_03 $tplAccel.frmRow0.entCell_03
  variable Cell_10 $tplAccel.frmRow1.entCell_10
  variable Cell_11 $tplAccel.frmRow1.entCell_11
  variable Cell_12 $tplAccel.frmRow1.entCell_12
  variable Cell_13 $tplAccel.frmRow1.entCell_13
  variable Cell_20 $tplAccel.frmRow2.entCell_20
  variable Cell_21 $tplAccel.frmRow2.entCell_21
  variable Cell_22 $tplAccel.frmRow2.entCell_22
  variable Cell_23 $tplAccel.frmRow2.entCell_23
  variable Cell_30 $tplAccel.frmRow3.entCell_30
  variable Cell_31 $tplAccel.frmRow3.entCell_31
  variable Cell_32 $tplAccel.frmRow3.entCell_32
  variable Cell_33 $tplAccel.frmRow3.entCell_33
  variable CellWidth 10
  variable AccelMatrixDisplayInit 0
  ...
  proc Delete {} {
	variable tplAccel
	variable AccelMatrixDisplayInit
    set AccelMatrixDisplayInit 0

	wm withdraw $tplAccel
  }
  ...
  proc Initialize {} {
    ...
    variable CellWidth
    variable AccelMatrixDisplayInit
	set AccelMatrixDisplayInit 1


    # Initialization of matrix display
    if { $RobLab::VelMatrixDisplayInit == 1  } {
        RobLab::CreateWindow "" wndAccelMatrixDisplay "Acceleration" "$RobLab::AccelMD_Geometry" $RobLab::WndMinSizeX $RobLab::WndMinSizeY . 0 { AccelMatrixDisplay::Delete } $RobLab::VirtualGridSize
    } else {
        RobLab::CreateWindow "" wndAccelMatrixDisplay "Acceleration" "$RobLab::AccelMD1_Geometry" $RobLab::WndMinSizeX $RobLab::WndMinSizeY . 0 { AccelMatrixDisplay::Delete } $RobLab::VirtualGridSize
    }
    
    # Row 0
    frame $tplAccel.frmRow0
    ...
    pack $tplAccel.frmRow0 -side top -fill both -expand true
    ...
    pack $tplAccel.frmRow1 -side top -fill both -expand true
    ...
    pack $tplAccel.frmRow2 -side top -fill both -expand true
    ...
    pack $tplAccel.frmRow3 -side top -fill both -expand true
