/** \defgroup driver_usb	DRIVER USB
    \ingroup Sistema_de_Comunicación
	
	\brief controlador del dispositivo CY7C68013 FX2. Este driver fué suministrado por CYPRESS, quien fué 
	la empresa que fabricó el controlador de periféricos USB.
	
	\code #include <ezusbys.h> \endcode
*/
