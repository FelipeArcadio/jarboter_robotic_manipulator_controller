...
// IF/Wait  IF        IF        IF        Wait 1    Wait 1    Wait 1    Wait 1             
//   Term A USB_EN    USB_READ  USB_READ                                                   
//   LFunc  AND       AND       AND                                                        
//   Term B USB_EN    USB_READ  USB_READ                                                   
// Branch1  Then 0    Then 1    Then 6                                                     
...
// Int Trig No Int    No Int    No Int    No Int    No Int    No Int    No Int             
// IF/Wait  IF        IF        IF        Wait 1    Wait 1    Wait 1    Wait 1             
//   Term A USB_EN    USB_WRTE  USB_WRTE                                                   
//   LFunc  AND       AND       AND                                                        
//   Term B USB_EN    USB_WRTE  USB_WRTE                                                   
// Branch1  Then 0    Then 1    Then 6                                                     
// Branch0  Else 1    Else 2    Else 2                                                     
// Re-Exec  No        No        No                                                         
// Sngl/CRC Default   Default   Default   Default   Default   Default   Default            
...
// Wave 2                                                                                  
/* LenBr */ 0x01,     0x0A,     0x32,     0x01,     0x01,     0x01,     0x01,     0x07,    
/* Opcode*/ 0x01,     0x01,     0x03,     0x0C,     0x00,     0x00,     0x04,     0x00,    
