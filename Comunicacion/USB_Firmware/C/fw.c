/**	\ingroup firmware_usb
	\brief ejecuta la inicialización del dispositivo y la gestión  de las peticiones del 
	estándar USB. Este archivo fué suministrado por el fabricante Cypress.
*/
...
#define   max(a,b) (((a)>(b))?(a):(b))
  ...
  // GPIFTRIG
  //
  // Remember that read-modify-write instructions like:
  //	GPIFIE |= 0x02;
  // ...must be avoided for these registers...
